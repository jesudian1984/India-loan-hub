        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start gap-3 rounded-lg border border-border bg-background/60 p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto w-full">
            <Card className="bg-gradient-to-br from-primary to-primary/80 border-none shadow-xl">
              <CardContent className="p-5 flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-primary-foreground">Up to 50%</h3>
            ...
            <Card className="bg-gradient-to-br from-accent to-accent/80 border-none shadow-xl">
              <CardContent className="p-5 flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-accent-foreground">1 Payment</h3>
